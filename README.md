...
1. Click [this link](https://www.terminaltemple.com/) to open a terminal practice session in your browser. You should be looking at a full-screen simulated terminal in your browser called *Terminal Temple*. You will do all your work in this simulated terminal environment.
